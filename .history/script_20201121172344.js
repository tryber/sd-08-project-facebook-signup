...
function guardarTexto() {
  ...
  paragrafoBoasVindas.innerHTML = `Olá, ${entradas[0].value} ${entradas[1].value}
   e-mail ou telefone ${entradas[2].value}, data de nascimento ${entradas[3].value} genero ${selecionado}`;
}
